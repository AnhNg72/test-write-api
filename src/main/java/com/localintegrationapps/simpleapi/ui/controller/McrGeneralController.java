...
import com.localintegrationapps.simpleapi.service.mcr.*;
...
@RestController
@RequestMapping("/api/mcr")
public class McrGeneralController {

    McrMaterialService materialService;
    McrOrdersService ordersService;
    McrDocumentService documentService;
    McrAddressService addressService;
    McrComponentService componentService;

    public McrGeneralController(McrMaterialService materialService,
                                McrOrdersService ordersService,
                                McrDocumentService documentService,
                                McrAddressService addressService,
                                McrComponentService componentService) {
