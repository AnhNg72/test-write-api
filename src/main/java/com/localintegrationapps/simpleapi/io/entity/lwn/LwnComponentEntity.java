...
import com.localintegrationapps.simpleapi.io.entity.BaseComponent;
import com.localintegrationapps.simpleapi.io.entity.ComponentId;

import javax.persistence.*;

@Entity
@Table(name="components", schema="lwn")
@IdClass(ComponentId.class)
public class LwnComponentEntity extends BaseComponent {}
