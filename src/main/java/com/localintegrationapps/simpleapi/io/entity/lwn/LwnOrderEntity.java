...
import com.localintegrationapps.simpleapi.io.entity.BaseOrder;
import com.localintegrationapps.simpleapi.io.entity.OrderId;

import javax.persistence.*;

@Entity
@Table(name="orders", schema="lwn")
@IdClass(OrderId.class)
public class LwnOrderEntity extends BaseOrder {}
