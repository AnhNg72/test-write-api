package com.localintegrationapps.simpleapi.io.entity.lwn;

import com.localintegrationapps.simpleapi.io.entity.BaseAddress;
...
@Entity
@Table(name = "addresses", schema = "lwn")
public class LwnAddressEntity extends BaseAddress { }

//@Entity
//@Table(name = "addresses", schema = "MCR")
//public class McrAddress extends BaseAddress { }